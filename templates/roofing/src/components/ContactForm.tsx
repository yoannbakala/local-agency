    ...
    >
      ...
      <div>
        ...
        <textarea id="message" name="message" rows={4}
          className="w-full px-4 py-3 border border-slate-300 rounded-lg focus:ring-2 focus:ring-accent-500 focus:border-accent-500 outline-none resize-y" />
      </div>
      <button type="submit"
        className="w-full bg-accent-500 text-primary-950 py-4 rounded-lg font-bold text-lg hover:bg-accent-400 transition-colors cursor-pointer">
        Send My Request
      </button>
